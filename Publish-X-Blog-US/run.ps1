# ============================================================================
# Publish-X-Blog-US - Posts a blog to X on Thursday 13:30 UTC (US morning)
# ============================================================================
# Timer trigger: fires once per week at Thursday 13:30 UTC.
...
Write-Host "Publish-X-Blog-US triggered at $($currentUTCtime.ToString('yyyy-MM-dd HH:mm:ss')) UTC"
